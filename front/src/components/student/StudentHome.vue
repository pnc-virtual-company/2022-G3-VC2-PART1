<template>
  <div class="">
    ...
    <div v-for="info in student_data" :key="info" class=" mt-5 m-auto w-ful w-2/4 bg-white rounded-lg border  shadow-md dark:bg-gray-800 dark:border-gray- border-t-4 border-indigo-200 border-t-teal-700">
      ...
      <button style="margin-left: 75%;" type="button" class=" mt-10 mb-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Get start
