<template>
    <form class="lg:w-5/12 md:w-6/12 sm:w-9/12 w-11/12 m-auto p-5 rounded border-2" action="">
        ...
        <h1 class="text-center text-2xl mt-3 mb-4 font-bold">Reset Password</h1>
        ...
        <button type="button" @click="newPassword" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
    </form>
</template>
